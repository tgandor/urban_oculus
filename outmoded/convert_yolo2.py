...
parser = argparse.ArgumentParser(description='Yolo v2 converter based on YAD2K')
...
parser.add_argument(
    '-fcnv',
    '--fully-convolutional',
    help='Convert as fully convolutional, set input shape to (None, None, 3).',
    action='store_true')
...
def _main(args):
    ...
    for section in cfg_parser.sections():
        ...
        if section.startswith('convolutional'):
            ...
            # Configs not currently handled during model definition.
